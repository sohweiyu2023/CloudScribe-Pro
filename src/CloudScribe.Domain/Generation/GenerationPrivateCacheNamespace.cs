...
public sealed record PrivateCacheLookupKey(string HmacSha256)
{
    ...
    public static PrivateCacheLookupKey Derive(ReadOnlySpan<byte> hmacKey, GenerationCacheTrustContext trustContext, ReadOnlySpan<byte> compiledPayload)
    {
        ...
        foreach (var value in trustContext.Values()) Append(buffer, value);
