...
def build_checks(root: Path) -> list[Check]:
    ...
    marker_specs = (
        ...
        (capture, "17-minimum-window-text-scale-200", "minimum-window 200% case"),
    ...
    session_specs = (
        ...
        (state.get("required_dotnet_sdk") == "10.0.302", "required SDK"),
        ...
        (state.get("stage2_source_implemented") is True, "Stage 2 source implemented"),
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Run CloudScribe's deterministic 149-check Stage 2 Python/material regression inventory in 15 stable shards.")
